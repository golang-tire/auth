...
export { default as Resources } from './resources/list';
export { default as ResourceEdit } from './resources/edit';
export { default as Objects } from './objects/list';
export { default as ObjectEdit } from './objects/edit';
